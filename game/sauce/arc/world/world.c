internal void TempInitGameWorld()
{
	...
	{
		Entity *tree = NewEntity("Tree", ENTITY_TYPE_resource, &core->world_data->floating_chunk);
	...
	{
		Entity *hills3 = NewEntity("Hill", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(hills3, v2(-272.0f, 0.0f), STATIC_SPRITE_hills_1_v1, 5.1f, v2(0.4f, 0.1f));
		Entity *hills1 = NewEntity("Hill", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(hills1, v2(-93.0f, 0.0f), STATIC_SPRITE_hills_1_v2, 5.0f, v2(0.4f, 0.1f));
		Entity *hills2 = NewEntity("Hill", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(hills2, v2(93.0f, 0.0f), STATIC_SPRITE_hills_1_v1, 5.1f, v2(0.4f, 0.1f));
		Entity *hills4 = NewEntity("Hill", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(hills4, v2(272.0f, 0.0f), STATIC_SPRITE_hills_1_v2, 5.0f, v2(0.4f, 0.1f));

		{
			Entity *bg1_tree_1 = NewEntity("bgtree", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		...
		{
			Entity *bg1_shrub = NewEntity("Bg1 Shrub", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		...
		{
			Entity *bg1_sapling = NewEntity("Bg1 Sapling", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	...
	{
		Entity *bg2_hills3 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg2_hills3, v2(-300.0f, 0.0f), STATIC_SPRITE_bg2_hills_v1, 6.1f, v2(0.6f, 0.2f));
		Entity *bg2_hills2 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg2_hills2, v2(-100.0f, 0.0f), STATIC_SPRITE_bg2_hills_v1, 6.1f, v2(0.6f, 0.2f));
		Entity *bg2_hills4 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg2_hills4, v2(100.0f, 0.0f), STATIC_SPRITE_bg2_hills_v1, 6.0f, v2(0.6f, 0.2f));
		Entity *bg2_hills1 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg2_hills1, v2(300.0f, 0.0f), STATIC_SPRITE_bg2_hills_v1, 6.0f, v2(0.6f, 0.2f));

		{
			Entity *bg2_tree = NewEntity("bg2 tree", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		...
		{
			Entity *bg2_shrub = NewEntity("bg2 shrub", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	...
	{
		Entity *bg3_hills1 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg3_hills1, v2(100.0f, 0.0f), STATIC_SPRITE_bg3_hills_v1, 7.0f, v2(0.75f, 0.3f));
		Entity *bg3_hills2 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg3_hills2, v2(-100.0f, 0.0f), STATIC_SPRITE_bg3_hills_v1, 7.0f, v2(0.75f, 0.3f));
		Entity *bg3_hills3 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg3_hills3, v2(300.0f, 0.0f), STATIC_SPRITE_bg3_hills_v1, 7.0f, v2(0.75f, 0.3f));
		Entity *bg3_hills4 = NewEntity("hills", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		SetupBackgroundEntity(bg3_hills4, v2(-300.0f, 0.0f), STATIC_SPRITE_bg3_hills_v1, 7.0f, v2(0.75f, 0.3f));

		{
			Entity *bg3_tree_1 = NewEntity("bgtree", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
		...
		{
			Entity *bg3_shrub = NewEntity("bg3 shrub", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	...
	Entity *mid_mountains_1 = NewEntity("Mountains", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	SetupBackgroundEntity(mid_mountains_1, v2(-250.0f, 0.0f), STATIC_SPRITE_mid_mountains, 8.0f, v2(0.93f, 0.68f));
	Entity *mid_mountains_2 = NewEntity("Mountains", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	SetupBackgroundEntity(mid_mountains_2, v2(-850.0f, 0.0f), STATIC_SPRITE_mid_mountains, 8.0f, v2(0.93f, 0.68f));
	Entity *mid_mountains_3 = NewEntity("Mountains", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	SetupBackgroundEntity(mid_mountains_3, v2(350.0f, 0.0f), STATIC_SPRITE_mid_mountains, 8.0f, v2(0.93f, 0.68f));

	Entity *far_mountains_1 = NewEntity("Mountains", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	SetupBackgroundEntity(far_mountains_1, v2(0.0f, 0.0f), STATIC_SPRITE_far_mountains, 9.0f, v2(0.95f, 0.7f));
	Entity *far_mountains_2 = NewEntity("Mountains", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	SetupBackgroundEntity(far_mountains_2, v2(-600.0f, 0.0f), STATIC_SPRITE_far_mountains, 9.0f, v2(0.95f, 0.7f));
	Entity *far_mountains_3 = NewEntity("Mountains", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	SetupBackgroundEntity(far_mountains_3, v2(600.0f, 0.0f), STATIC_SPRITE_far_mountains, 9.0f, v2(0.95f, 0.7f));

	{
		core->player = NewEntity("Player", ENTITY_TYPE_character, &core->world_data->floating_chunk);
	...
	{
		core->sword = NewEntity("Sword", ENTITY_TYPE_item, &core->world_data->floating_chunk);
		core->sword->flags |= ENTITY_FLAGS_no_delete;
		AttachItem(core->sword, ITEM_flint_sword, 1);
	}

	{
		core->backpack = NewEntity("Backpack", ENTITY_TYPE_storage, &core->world_data->floating_chunk);
		core->backpack->flags |= ENTITY_FLAGS_no_delete;
		AttachStorage(core->backpack, 9);

		core->hotbar = NewEntity("Hotbar", ENTITY_TYPE_storage, &core->world_data->floating_chunk); // Hotbar should technically be attached to the player enti, &core->world_data->floating_chunkty
	...
	for (int i = -10; i < 11; i++)
	{
		Entity *ground = NewEntity("Ground", ENTITY_TYPE_ground, &core->world_data->floating_chunk);
		...
		Entity *ground_rocks = NewEntity("GroundRocks", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
	...
	for (int i = 0; i < 12; i++)
	{
		Entity *cloud = NewEntity("Cloud", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
...
internal void DrawWorld()
{
	...
	if (core->draw_velocity)
	{
		...
		for (int i = 0; i < chunk_count; i++)
		{
			...
			for (int j = 0; j < chunk->component_set.velocity_component_count; j++)
			{
				VelocityComponent *velocity_comp = &chunk->component_set.velocity_components[j];
...
internal void UpdateParallax()
{
	...
	for (int i = 0; i < chunk_count; i++)
	{
		...
		for (int j = 0; j < chunk->component_set.parallax_component_count; j++)
		{
			ParallaxComponent *parallax_comp = &chunk->component_set.parallax_components[j];
	...
	for (int i = 0; i < core->cloud_count; i++)
	{
		...
		if (cloud)
		{
			...
			if (-core->camera_position.x + cloud_parallax->desired_position.x >= bound)
			{
				...
				Entity *new_cloud = NewEntity("Cloud", ENTITY_TYPE_scenic, &core->world_data->floating_chunk);
...
{
	chunks[0] = &core->world_data->floating_chunk;
	return 1;
}

internal ChunkData *GetChunkAtPosition(v2 position)
{
	return &core->world_data->floating_chunk;
}