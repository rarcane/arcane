...
#define LAYER_STRUCTURE 1
#define LAYER_GROUND_ROCKS 2 // Small rocks that go behind the player to give extra depth
#define LAYER_TREE 3
#define LAYER_SHRUB 4
