...
global TsDevTerminal *global_tsdevterminal = 0;

typedef i32 TsDevTerminalCommandProcedure(u32 word_count, char **words);
#define TSDEVTERMINAL_COMMAND_PROC(name) i32 name(u32 word_count, char **words)
...
void TsDevTerminalInit(MemoryArena *arena);
void TsDevTerminalSetVariables(int variable_count, TsDevTerminalVariable *variables, MemoryArena *arena);
void TsDevTerminalSetCommands(int command_count, TsDevTerminalCommand *commands, MemoryArena *arena);
void TsDevTerminalSetRenderCallbacks(TsDevTerminalRenderFilledRect *RenderFilledRect, TsDevTerminalRenderText *RenderText, TsDevTerminalRenderTextN *RenderTextN);
char *TsDevTerminalLog(i32 flags, char *format, ...);
void TsDevTerminalPushCommandToHistory(char *command);
void TsDevTerminalUpdate(f32 delta_t);
void TsDevTerminalRender(void);
