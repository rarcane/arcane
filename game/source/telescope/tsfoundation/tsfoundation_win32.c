...
#include "tsfoundation_win32_opengl.c"
...
int WinMain(HINSTANCE instance, HINSTANCE prev_instance, LPSTR lp_cmd_line, int n_show_cmd)
{
	...
	// NOTE(rjf): // NOTE(rjf): // NOTE(rjf):
	// NOTE(rjf): THE REASON WHY THIS IS CRASHING IS BECAUSE YOU AREN'T ALLOCATING
	// THE RENDERER STRUCT!!! FIGURE OUT A WAY TO DO THAT (OR MAYBE NOT DO IT AT ALL?)
	// NOTE(rjf): // NOTE(rjf): // NOTE(rjf):
	// TODO(rjf): // TODO(rjf): // TODO(rjf):
	// NOTE(rjf): // NOTE(rjf): // NOTE(rjf):
