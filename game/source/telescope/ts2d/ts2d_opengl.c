...
void
Ts2dTextureCleanUp(Ts2dTexture *texture)
{
...
void
Ts2dMaterialCleanUp(Ts2dMaterial *material)
{
...
void
Ts2dSubModelCleanUp(Ts2dSubModel *sub_model)
{
    if(sub_model->vao)
    {
...
void
Ts2dModelCleanUp(Ts2dModel *model)
{
...
void
Ts2dOpenGLFBOBind(Ts2dOpenGLFBO *fbo)
{
...
void
Ts2dOpenGLFBOClear(Ts2dOpenGLFBO *fbo)
{
...
void
_Ts2dOpenGLFBORender(GLuint shader, Ts2dOpenGLFBO *fbo, v4 source, v4 dest)
{
...
void
Ts2dOpenGLFBORender(Ts2dOpenGLFBO *fbo, v4 source, v4 dest)
{
    _Ts2dOpenGLFBORender(global_ts2d->shaders[TS2D_OPENGL_SHADER_fbo], fbo, source, dest);
}

void
Ts2dOpenGLBlurredFBORender(GLuint texture, f32 width, f32 height,
